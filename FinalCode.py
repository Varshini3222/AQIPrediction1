...
print("🚀 SUPER HYBRID MODEL: (FNN+GRU→SlideNN) + (RF+DT→XGB) → FINAL META")
print("=" * 80)
...
# ============================================================================
print("\n" + "=" * 50)
print("🎯 CREATING SUPER HYBRID: DL + ML → Final Meta")
print("=" * 50)
...
models_comparison = {
    ...
    'SUPER HYBRID': '',
    '  🚀 SUPER HYBRID (DL+ML→Final)': super_metrics
}
...
print(f"  • Final Hybrid: R² = {super_r2:.4f}")
