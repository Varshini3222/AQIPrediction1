...
print("--- SVM Classifier (New Dataset: 2014–2025) ---")
...
joblib.dump(model, 'aqi_svm_model.joblib')
print("\n💾 Model saved as 'aqi_svm_model.joblib'")
print("\n✅ Process complete! SVM AQI classifier is ready to use.")
