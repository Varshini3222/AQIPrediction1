...
# hybrid_rf_gb.py
print("="*70)
print("HYBRID MODEL: Random Forest + Gradient Boosting")
print("="*70)
...
hybrid_pred = (rf_pred * rf_weight) + (gb_pred * gb_weight)
...
plt.ylabel('Actual')
plt.tight_layout()
plt.savefig('confusion_rf_gb.png', dpi=300, bbox_inches='tight')
plt.show()

print("\n" + "="*70)

joblib.dump({'rf': rf_model, 'gb': gb_model, 'weights': [rf_weight, gb_weight]},
           'hybrid_rf_gb.joblib')