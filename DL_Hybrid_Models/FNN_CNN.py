...
hybrid_pred = (fnn_pred + cnn_pred) / 2
...
plt.title('Confusion Matrix - FNN + CNN\nAccuracy: {:.2f}%'.format(accuracy_category))
plt.xlabel('Predicted')
plt.ylabel('Actual')
plt.tight_layout()
plt.savefig('confusion_dl_fnn_cnn.png', dpi=300, bbox_inches='tight')
plt.show()

print("\n" + "="*70)

joblib.dump({'fnn': fnn_model, 'cnn': cnn_model},
           'hybrid_dl_fnn_cnn.joblib')